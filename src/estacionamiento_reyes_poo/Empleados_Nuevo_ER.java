 ...
 * @author reyesj1g
 */
public class Empleados_Nuevo_ER extends javax.swing.JFrame {
    
    private String nombre, puesto, salario;
    private int activo = 0;
    private SQLAdmin sql = new SQLAdmin("localhost:3306","java","password","estacionamiento_reyes");

    public Empleados_Nuevo_ER() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBoxPuesto.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Acomodador", "Administrador", "Ing. Software" }));
        ...
        jLabel4.setText("Agregar empleado nuevo");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        puesto = jComboBoxPuesto.getSelectedItem().toString();
        salario = jTextFieldSalario.getText();
        if(jCheckBoxActivo.isSelected()){
            activo = 1;
        }
        sql.guardarEmpleados(nombre, puesto, salario, activo);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Empleados_Nuevo_ER().setVisible(true);
            }
        });
    }
